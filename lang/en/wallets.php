...
return [
    'cannot_delete_with_balance' => 'Cannot delete a wallet with a remaining balance. Please settle the balance first.',
    'cannot_delete_with_owner' => 'Cannot delete a wallet that is associated with an account owner.',
